...
//define device id
const char* DigitalInput = "f348d65c-9693-4187-be2a-c94b209731f6";  //Replace this with YOUR deviceID for the push button
const char* LEDLight = "cd587da7-3317-4bab-91d1-a4995e7ab7c9";      //Replace this with YOUR deviceID for the first LED
const char* PIRsensor = "d2f1d92b-05f6-4b1f-aa48-fa2be39728eb";     //Replace this with YOUR deviceID for the PIR sensor
